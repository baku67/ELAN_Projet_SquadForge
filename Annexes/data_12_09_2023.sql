...
INSERT INTO `game` (`id`, `genre_id`, `title`, `editor`, `publish_date`, `description`, `color`, `logo`, `banner`, `font_color`, `tiny_logo`, `sub_banner`, `nbr_places`, `site_logo`, `show_icon_search_page`, `slug`) VALUES
	(1, 1, 'Overwatch', 'Blizzard', '2017-05-01 21:16:23', 'FPS dynamique et efficace', '#ff9b00', 'overwatchLogo.png', 'overwatchBanner.jpg', 'var(--background-color)', 'overwatch1.png', 'overwatchHeaderBg.jpg', 0, 'logoSquadForge_overwatch.png', 1, 'overwatch'),
	(2, 1, 'Call of Duty', 'Activision', '2002-05-01 21:16:54', 'FPS connu ', '#74c814', 'callOfDutyLogo.png', 'codBanner.jpg', 'var(--background-color)', 'cod1.png', 'callofdutyHeaderBg.jpg', 0, 'logoSquadForge_cod.png', 0, 'call-of-duty'),
...
INSERT INTO `group` (`id`, `leader_id`, `game_id`, `title`, `description`, `nbr_places`, `creation_date`, `restriction_18`, `restriction_lang`, `status`, `img_url`, `restriction_mic`, `restriction_img_proof`, `candidature_txt`, `slug`) VALUES
	(36, 7, 1, 'La team overwatch', 'fzefzef', 2, '2023-06-21 21:39:31', 0, 'fr', 'hidden', 'test1.jpg', 0, 0, NULL, 'la-team-overwatch'),
	(38, 3, 5, 'Team PUBG du dimanche', 'On joue le dimanche aprèm pour le fun', 3, '2023-06-30 01:14:35', 1, 'fr', 'public', 'test2.jpg', 0, 1, 'Yolo ', 'team-pubg-du-dimanche'),
	(39, 3, 6, 'Team lol', 'C''est la team mdr lol', 5, '2023-07-04 01:03:57', 1, 'en', 'public', 'test3.png', 1, 1, 'hello\r\n', 'team-lol'),
	(47, 7, 4, 'Valo team numéro One', 'Ola', 6, '2023-07-08 06:14:54', 1, NULL, 'public', 'test4.png', 0, 1, NULL, 'valo-team-numero-one'),
	(49, 3, 2, 'fzefzefzef', 'zefzefzef', 2, '2023-08-22 14:57:39', 1, NULL, 'public', 'test5.jpg', 1, 1, NULL, 'fzefzefzef'),
	(50, 3, 6, 'fsefse', 'Miaou miaou miaou miaou mioau ', 4, '2023-08-30 20:24:05', 1, 'fr', 'public', 'test6.jpg', 1, 0, NULL, 'fsefse'),
	(51, 7, 2, 'HELOO', 'efsefseqzdqz dqz dqz', 5, '2023-08-30 20:25:48', 1, 'fr', 'public', 'test7.jpg', 1, 1, 'fsefse', 'helloo'),
	(52, 3, 4, 'Team Valorant chill', 'Sessions : \r\n - Vendredi 18h-00h\r\n - Samedi 20h-00h', 6, '2023-09-04 00:20:12', 1, NULL, 'public', 'test8.jpg', 1, 0, NULL, 'team-valorant-chill'),
	(53, 3, 1, 'Team Overwatch 01', 'TEAM NUMBER ONE, sessions le samedi soir', 5, '2023-09-04 00:50:31', 1, NULL, 'public', 'test9.jpg', 1, 0, NULL, 'team-overwatch-01');
