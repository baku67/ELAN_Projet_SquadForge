...
INSERT INTO `game` (`id`, `genre_id`, `title`, `editor`, `publish_date`, `description`, `color`, `logo`, `banner`, `font_color`, `tiny_logo`) VALUES
	...
	(5, 3, 'PUBG', 'Krafton', '2016-05-02 02:52:53', 'Battle royal pas ouf', '#ffd632', 'pubgLogo.jpeg', 'pubgBanner.jpg', 'white', NULL);
...
-- Listage des données de la table squadforge.notation : ~0 rows (environ)
...
-- Listage des données de la table squadforge.topic : ~15 rows (environ)
...
-- Listage des données de la table squadforge.topic_post : ~1 rows (environ)
