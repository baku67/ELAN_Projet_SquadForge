...
-- Listage des données de la table squadforge.doctrine_migration_versions : ~3 rows (environ)
...
-- Listage des données de la table squadforge.favoris : ~1 rows (environ)
DELETE FROM `favoris`;
...
DELETE FROM `game`;
INSERT INTO `game` (`id`, `genre_id`, `title`, `editor`, `publish_date`, `description`, `color`, `logo`, `banner`, `font_color`, `tiny_logo`, `sub_banner`) VALUES
	(1, 1, 'Overwatch', 'Blizzard', '2017-05-01 21:16:23', 'FPS dynamique et efficace', '#ff9b00', 'overwatchLogo.png', 'overwatchBanner.jpg', 'white', 'overwatch1.png', 'overwatchHeaderBg.jpg'),
	(2, 1, 'Call of Duty', 'Activision', '2002-05-01 21:16:54', 'FPS connu ', '#74c814', 'callOfDutyLogo.png', 'codBanner.jpg', 'white', 'cod1.png', 'callofdutyHeaderBg.jpg'),
	(3, 2, 'Isaac', 'Edmund McMillen', '2003-05-01 23:59:12', 'Oulah', '#e24f37', 'isaacLogo.jpg', 'isaacBanner.jpg', 'white', 'isaac1.png', 'overwatchHeaderBg.jpg'),
	(4, 1, 'Valorant', 'Riot Games', '2021-05-02 01:41:56', 'Fps mélange entre Overwatch et Counter Strike', '#ff4655', 'valorantLogo.png', 'valorantBanner.jpg', 'white', 'valorant1.png', 'overwatchHeaderBg.jpg'),
	(5, 3, 'PUBG', 'Krafton', '2016-05-02 02:52:53', 'Battle royal pas ouf', '#ffd632', 'pubgLogo.jpeg', 'pubgBanner.jpg', 'white', 'pubg1.png', 'overwatchHeaderBg.jpg');
...
-- Listage des données de la table squadforge.group : ~2 rows (environ)
DELETE FROM `group`;
INSERT INTO `group` (`id`, `leader_id`, `game_id`, `title`, `description`, `nbr_places`, `creation_date`, `restriction_18`, `restriction_lang`, `status`, `img_url`, `restriction_mic`) VALUES
	(5, 3, 4, 'test nouvelle team', 'description de la nouvelle team', 6, '2023-06-04 17:51:24', 0, 'fr', 'hided', NULL, 1),
	(6, 3, 4, 'test redirection postAdd', 'dzeefezfze', 10, '2023-06-04 17:56:47', 0, 'gtr', 'public', NULL, 0);

-- Listage des données de la table squadforge.media : ~27 rows (environ)
DELETE FROM `media`;
...
-- Listage des données de la table squadforge.media_post : ~11 rows (environ)
...
-- Listage des données de la table squadforge.media_post_like : ~9 rows (environ)
...
-- Listage des données de la table squadforge.media_upvotes : ~1 rows (environ)
DELETE FROM `media_upvotes`;
INSERT INTO `media_upvotes` (`media_id`, `user_id`) VALUES
	(43, 3);

-- Listage des données de la table squadforge.membre_group : ~0 rows (environ)
...
-- Listage des données de la table squadforge.post_like : ~11 rows (environ)
...
-- Listage des données de la table squadforge.topic : ~26 rows (environ)
DELETE FROM `topic`;
